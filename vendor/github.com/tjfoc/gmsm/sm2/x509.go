...
func parseCertificate(in *certificate) (*Certificate, error) {
	...
	logger.Debugf("AKI：%s,SKI:%s", hex.EncodeToString(out.AuthorityKeyId), hex.EncodeToString(out.SubjectKeyId))
	return out, nil
}
...
func CertToPEM(certificate *Certificate) string {
	...
	if err != nil {
		logger.Warning("Failed converting certificate to asn1", err)
		return ""
	}
	return cert.String()
}
